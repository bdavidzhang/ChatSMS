...
def webhook():
    ...
    if sender_id not in conversation_history:
        ...
        conversation_history[sender_id] = [
            {"role": "system", "content": "You are a friendly and helpful chat assistant. Keep you messages within 160 characters."}
        ]
        print(f"Starting new chat session for {sender_id}")
